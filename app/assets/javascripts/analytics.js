...
var graphMyShiz = function(labels, data) {
    ...
    var width = 800,
        ...
        r = Raphael("rank_history", width, height),
    ...
    var path = r.path().attr({stroke: color, "stroke-width": 4, "stroke-linejoin": "round"}),
        ...
        leave_timer,
        blanket = r.set();
    label.push(r.text(60, 12, "24 rank").attr(txt));
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: "rank " + data}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
